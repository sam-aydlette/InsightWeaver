...
def interactive_mode():
    ...
    click.echo("  forecast            - Generate 1-year trend forecast")
    ...
    click.echo("  brief -cs -g           (global cybersecurity news)")
    click.echo("  brief -cs --email      (cybersecurity brief, send via email)")
    click.echo()
