...
The synthesis product that used to call it is deleted; this file is not,
because it encodes two outages that cost live runs and that a rewrite from a
blank file would reintroduce -- see :data:`DEFAULT_MODEL` and
:func:`_response_text` below.
"""
...
class ClaudeClient:
    ...
    async def analyze_with_context(
        ...
        Args:
            context: Curated context dictionary supplied by the caller
