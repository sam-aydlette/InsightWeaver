...
def trust_pipeline(mock_claude_client, mocker):
    ...
    pipeline.bias_analyzer.analyze = mocker.AsyncMock(
...
def complete_analysis_result():
    ...
    return {
        ...
        "facts": {
            ...
            "verifications": [
                {
                    "claim": {"text": "Fact 1", "type": "FACT", "confidence": 0.9, "reasoning": "Test"},
                    "verdict": "VERIFIED",
                    "confidence": 0.95,
                    "reasoning": "Confirmed",
                    "caveats": [],
                ...
                {
                    "claim": {"text": "Fact 2", "type": "FACT", "confidence": 0.8, "reasoning": "Test"},
...
def json_country_extraction_response():
    ...
    return json.dumps({
        "country": "India",
        "confidence": 0.98,
        "reasoning": "Query explicitly mentions India"
    })
