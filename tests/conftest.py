...
def sample_claims():
    ...
    return [
        ...
        Claim("This suggests a strong labor market", "INFERENCE", 0.7, "Logical conclusion from data"),
...
def sample_verifications():
    ...
    return [
        ...
        FactVerification(
            claim=Claim("The sky appears blue due to Rayleigh scattering", "FACT", 0.9, "Scientific fact"),
            verdict="VERIFIED",
            confidence=0.98,
        ...
        FactVerification(
            claim=Claim("The quantum flux capacitor was invented in 1985", "FACT", 0.7, "Unverifiable claim"),
...
def sample_fact_analysis():
    ...
    return {
        "verifications": [
            {
                "claim": {"text": "Python was created in 1991", "type": "FACT", "confidence": 0.9, "reasoning": "Historical fact"},
                "verdict": "VERIFIED",
                "confidence": 0.95,
                "reasoning": "Confirmed by multiple authoritative sources",
                "caveats": ["First public release was February 1991"],
            ...
            {
                "claim": {"text": "The quantum flux capacitor was invented in 1985", "type": "FACT", "confidence": 0.7, "reasoning": "Unverifiable claim"},
                "verdict": "UNVERIFIABLE",
                "confidence": 0.0,
                "reasoning": "Cannot verify this claim with available sources; appears to be fictional",
                "caveats": [],
            ...
            {
                "claim": {"text": "The president is John Smith", "type": "FACT", "confidence": 0.8, "reasoning": "Time-sensitive claim"},
                "verdict": "CONTRADICTED",
                "confidence": 0.9,
                "reasoning": "This contradicts current factual information",
                "caveats": [],
            ...
            {
                "claim": {"text": "The CEO is Jane Doe", "type": "FACT", "confidence": 0.8, "reasoning": "Time-sensitive claim"},
                "verdict": "OUTDATED",
                "confidence": 0.85,
                "reasoning": "This claim was true in 2023 but is now outdated",
                "caveats": [],
