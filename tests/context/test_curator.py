...
class TestContextCuratorInit:
    ...
    def test_init_with_default_profile(self, mock_get_profile):
    ...
    @patch("src.context.curator.get_user_profile")
    def test_init_with_custom_profile(self, mock_get_profile):
    ...
    @patch("src.context.curator.get_user_profile")
    def test_init_handles_missing_profile(self, mock_get_profile):
    ...
    @patch("src.context.curator.get_user_profile")
    def test_init_with_topic_filters(self, mock_get_profile):
...
class TestEstimateTokens:
    ...
    @patch("src.context.curator.get_user_profile")
    def test_estimate_tokens_basic(self, mock_get_profile):
    ...
    @patch("src.context.curator.get_user_profile")
    def test_estimate_tokens_empty_context(self, mock_get_profile):
...
class TestFormatUserProfile:
    ...
    @patch("src.context.curator.get_user_profile")
    def test_format_user_profile_basic(self, mock_get_profile, sample_user_profile):
    ...
    @patch("src.context.curator.get_user_profile")
    def test_format_user_profile_no_profile(self, mock_get_profile):
    ...
    @patch("src.context.curator.get_user_profile")
    def test_format_user_profile_handles_string_location(self, mock_get_profile):
...
class TestFormatArticles:
    ...
    @patch("src.context.curator.get_user_profile")
    def test_format_articles_basic(self, mock_get_profile, sample_article_for_context):
    ...
    def test_format_articles_uses_embedding_summary(
        self, mock_get_profile, sample_article_for_context
    ):
    ...
    @patch("src.context.curator.get_user_profile")
    def test_format_articles_handles_no_feed(self, mock_get_profile, sample_article_for_context):
...
class TestEnforceTokenBudget:
    ...
    @patch("src.context.curator.get_user_profile")
    def test_enforce_budget_under_limit(self, mock_get_profile):
    ...
    @patch("src.context.curator.get_user_profile")
    def test_enforce_budget_reduces_articles(self, mock_get_profile):
