...
SIZE: large
PERSISTENCE: SQLite in S3, single-writer Lambda -- chosen on shape, not price (see backlog/022 Q1). Revisitable before deploy; the cost comparison is unverified and recorded as such.
